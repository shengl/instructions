...
**按键**：在运行监控画面按F8键弹出\[功能菜单\]，按"Esc"键退出当前界面返回至\[编织运行\]界面。
...
**按键**：上、下键移动光标选择\[编织运行\]图标，按回车键弹出\[指定行停车\]提示框，通过上、下、左、右键移动光标选择需要修改的参数框，按回车键弹出小键盘，根据需求输入停车行数，再次按回车键完成输入，按"Esc"键退出。
